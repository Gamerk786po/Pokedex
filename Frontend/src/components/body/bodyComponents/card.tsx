...
const Card: React.FC<CardProps> = ({name, imgUrl}) => {
    return(
        ...
        <div className="h-[148.5px] max-h-[160px] w-[122px] group flex flex-col gap-1 shadow-2xl items-center justify-center border border-blue-300 rounded-xl transition-all duration-300 hover:cursor-pointer hover:border-blue-500">
